...
# 页面设置
st.set_page_config(page_title="画→音乐prompt生成器", page_icon="🎨", layout="wide")

# 标题
st.title("🎨 听听你的画")
st.markdown("让每一幅画，都找到自己的旋律")
...
# 上传图片
uploaded_file = st.file_uploader("选择一张画作图片", type=['jpg', 'jpeg', 'png'])
